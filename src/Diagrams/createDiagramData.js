import {
    getProgramHierarchy
} from './First_Iteration.js';
import {
    expandPgmHierarchy
} from './Further_Iterations.js';
import {
    fullyEliminateDiagram
} from './Elimination.js';
import {
    FindEndpoints
} from './CreateEndPoint.js';
...
export const createDiagData = (EntryPoint, programs) => {
    ...
    firstIteration = getProgramHierarchy(EntryPoint, programs, maxLvl, maxEntityChildren)
    ...
    while (Iterations < 10) {
        ...
        furtherIteration = expandPgmHierarchy(Diagram, lastEntityId, maxLvl, maxEntityChildren, programs)

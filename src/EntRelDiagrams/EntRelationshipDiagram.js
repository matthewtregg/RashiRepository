...
const createGoingUpObj = (startingPgm, entrels, DiagramChild, entityId, ChildId, InitialObj) => {
...
const getNestedChildrenGoingDown = (Obj, DiagramGoingDown) => {
  ...
  nextChildren = nextChildren.map((Obj) => {
...
const getNestedParentsGoingUp = (Obj, DiagramGoingUp) => {
  ...
  nextParents = nextParents.map((Obj) => {
...
const createGoingDownObj = (Entity, entrels, DiagramParent, entityId, parentId, InitialObj) => {
  //console.log(entrels);
  console.log(entrels)
  const CurrentRel = entrels.filter((rel) => {
...
export const buildChart = (entrels, startingPgm) => {
  ...
  console.log(DiagramGoingDown);
  console.log(DiagramGoingUp);

export const convertChildrenHierarchy = (Diagrams) => {
...
const getNonCoreRelations = (CoreRels, AllRels) => {
...
const getAllRelations = (DiagramEnts) => {
...
const getCoreRelations = (DiagramEnts) => {
  let DiagramEntsCopy = DiagramEnts.slice(0);
  let NewRels = DiagramEntsCopy.map((Ent) => {
